...
export default function Services(){
  const services = [
    ...
    { img: '/assets/images/webp-images/image-1.webp', title: 'General Pest Control', desc: 'Targeted treatments for household and commercial pests — cockroaches, ants, fleas, ticks, bedbugs, bees and flies. We perform a full inspection, recommend an integrated treatment plan and provide follow-up visits to ensure long-term control and peace of mind.' },
