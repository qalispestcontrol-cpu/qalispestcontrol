...
export default function Services(){
  const services = [
    ...
    { img: '/assets/images/QualisPestControl/image-4.jpeg', title: 'Fumigation Services', desc: 'Professional fumigation services for warehouses, storage facilities and large premises using certified protocols and safety measures. Our team handles planning, restricted access, safe application and post-fumigation clearance to minimize downtime.' },
    { img: '/assets/images/QualisPestControl/image-5.jpeg', title: 'Disinfection & Sanitization', desc: 'Post-treatment disinfection and sanitization to reduce microbial load and support healthy environments. Ideal after pest activity, outbreaks, or where hygiene levels must be improved quickly and effectively.' },
    { img: '/assets/images/QualisPestControl/image-6.jpeg', title: 'Bird Proofing', desc: 'Humane bird control solutions such as netting, spikes and exclusion systems designed to prevent roosting, nesting and contamination. We assess the site and implement long-term, maintenance-friendly solutions that protect building assets.' }
  ] 
